...
export function JobDetail({ jobId, onRedo }: Props) {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="p-4 border-b border-[#2e2722] flex-shrink-0">
        ...
        <div className="flex items-center gap-3 text-[10px] text-zinc-600 flex-wrap">
          ...
          {isFinished && (
            <button
              ...
              className="flex items-center gap-1 px-2 py-0.5 ml-auto rounded text-[10px] bg-[#2e2722] border border-[#2e2722] text-zinc-300 hover:text-white hover:border-indigo-700 transition-colors"
        ...
        {isFinished && redoOpen && (
          <form onSubmit={handleRedo} className="mt-3 p-3 rounded-md border border-indigo-900/50 bg-indigo-950/10 space-y-2">
            ...
            <textarea
              ...
              rows={2}
              className="w-full bg-[#1b1613] border border-[#2e2722] rounded-md px-3 py-2 text-xs text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-indigo-700 resize-none"
            />
            {redoImages.length > 0 && (
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-2 py-1.5 bg-[#1b1613] border border-[#2e2722] rounded-md text-zinc-500 hover:text-zinc-300 hover:border-zinc-600 transition-colors"
                title="Attach image"
              >
      ...
      <div className="flex-1 overflow-hidden flex flex-col min-h-0">
        ...
        <div className="px-4 py-2 border-b border-[#2e2722] flex items-center gap-2 flex-shrink-0 bg-[#181310]">
        ...
        <div className="flex-1 overflow-y-auto bg-[#100c0a] p-4 min-h-0">
          {output ? (
      ...
      {messages && messages.length > 0 && (
        <div className="border-t border-[#2e2722] flex-shrink-0 max-h-64 overflow-y-auto bg-[#161210]">
          <div className="px-4 py-2 border-b border-[#2e2722]">
            ...
            {messages.map((msg) => (
              <div key={msg._id} className={`flex gap-2 ${msg.role === "user" ? "flex-row-reverse" : "flex-row"}`}>
                ...
                <div className={`text-xs rounded-lg px-3 py-2 max-w-[85%] whitespace-pre-wrap ${
                  msg.role === "assistant"
                    ? "bg-[#221c18] text-zinc-300 border border-[#2e2722]"
      ...
      {isPending && (
        <div className="border-t border-[#2e2722] bg-[#181310] p-3 flex-shrink-0">
          ...
          <form onSubmit={handleAddPrompt} className="flex gap-2">
            ...
            <button
              ...
              className="px-2 py-2 bg-[#1b1613] border border-[#2e2722] rounded-md text-zinc-500 hover:text-zinc-300 hover:border-zinc-600 transition-colors flex-shrink-0"
              title="Attach files"
            >
              <Paperclip className="w-3.5 h-3.5" />
            </button>
            <input
              ...
              className="flex-1 bg-[#1b1613] border border-[#2e2722] rounded-md px-3 py-2 text-xs text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-indigo-700 transition-colors"
            />
            <button
              type="submit"
        ...
        <div className={`border-t p-3 flex-shrink-0 ${
          ...
          <form onSubmit={handleReply} className="flex gap-2">
            ...
            <input
              ...
              className={`flex-1 bg-[#1b1613] border rounded-md px-3 py-2 text-xs text-zinc-200 placeholder:text-zinc-600 focus:outline-none transition-colors ${
                isWaiting ? "border-yellow-700/60 focus:border-yellow-600" : "border-[#2e2722] focus:border-indigo-700"
              }`}
              autoFocus={isWaiting}
            />
            <button
